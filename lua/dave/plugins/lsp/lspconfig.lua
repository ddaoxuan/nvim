...
return {
  ...
  dependencies = {
    ...
    { 'j-hui/fidget.nvim', tag = 'legacy', config = true }, -- Useful status updates for LSP
  },
  ...
  config = function()
    ...
    local on_attach = function(_, bufnr)
      ...
      nmap('<leader>rs', ':LspRestart<cr>', 'Restart LSPs')

      -- Lesser used LSP functionality -- not sure ever needed
