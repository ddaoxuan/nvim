return {
  ...
  config = function()
    ...
    vim.keymap.set('n', ';t', require('telescope.builtin').oldfiles, { desc = '[;t] Find recently opened files' })
    vim.keymap.set('n', ';h', function()
      require('telescope.builtin').current_buffer_fuzzy_find(require('telescope.themes').get_dropdown {
        winblend = 10,
        previewer = false,
      })
    end, { desc = '[;h] Find within a file' })
    ...
    vim.keymap.set('n', ';b', '<cmd>lua require("telescope.builtin").help_tags()<cr>', opts)
